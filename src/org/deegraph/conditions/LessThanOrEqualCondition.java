...
public class LessThanOrEqualCondition extends CoerciveComparitorCondition {

    public LessThanOrEqualCondition(GraphDatabase graphDatabase, Condition c1, Condition c2) {
